...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td field-key='digital_library_files's> @foreach($digital_library->getMedia('digital_library_files') as $media)
                                <p class="form-group">
            ...
            <a href="{{ route('admin.digital_libraries.index') }}" class="btn btn-default">@lang('quickadmin.qa_back_to_list')</a>
        </div>
    </div>
@stop
