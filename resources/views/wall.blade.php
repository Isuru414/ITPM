...
<div class="super_container">
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
                ...
                <li class="menu_mm"><a href="wall">Events</a></li>
				<li class="menu_mm"><a href="digital">Digital Library</a></li>
			</ul>
		</nav>
	...
	<div class="blog">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="welcome_title">Upcoming Events</div>
				</div>
			</div>
			...
			<div class="row blog_row">
				...
				<!-- Blog Post -->
                @foreach($WallManagements as $WallManagement)
				<div class="col-lg-6">
					<div class="blog_post">
						<div class="blog_image" style="background-image:url(images/blog_7.jpg)"></div>
						<div class="blog_title_container">
							<div class="blog_post_category"><a href="#"></a></div>
							<div class="blog_post_title"><a href="blog_single.html">{{$WallManagement->title}}</a></div>
                            <div class="event_day">{{$WallManagement->date}}</div>
							<div class="blog_post_text">
								<p>{{$WallManagement->description}}</p>
							</div>
							<div class="read_more"><img src="images/right.png" alt=""></a></div>
						</div>
					</div>
				</div>
                @endforeach
