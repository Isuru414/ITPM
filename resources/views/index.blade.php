						...
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_right ml-auto">
									...
									@if (Auth::check())
										<span class="top_bar_title">logged in as {{ Auth::user()->email }}</span>
										<form action="{{ route('auth.logout') }}" method="post">
										{{ csrf_field() }}
										<span class="top_bar_title social_title"><input type="submit" value="logout"></span>
										</form>
										...
										{{ csrf_field() }}
											...
											<span class="top_bar_title social_title"><input type="submit" value="Login"></span> -->
			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						...
						<div class="home_button trans_200"><a href="{{ route('auth.register') }}">get started</a></div>
					</div>
				</div>
			</div>
		</div>
