...
<div class="super_container">
	...
	<div class="events">
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="section_title text-center">Digital Library</h2>
				</div>
			</div>
			<div class="row events_row">
				
				<!-- Event -->
                @foreach($DigitalLibrarys as $DigitalLibrary)
				<div class="col-lg-4 event_col">
					<div class="event">
						<div class="event_image"><img src="images/event_1.jpg" alt=""></div>
						<div class="event_date d-flex flex-column align-items-center justify-content-center">
							<div class="event_day">{{$DigitalLibrary->date}}</div>
							<div class="event_month"></div>
						</div>
						<div class="event_body d-flex flex-row align-items-center justify-content-start">
							<div class="event_title"><a href="#">{{$DigitalLibrary->title}}</a></div>
